...
using TZGCMS.WeiXin.MessageHandlers.CustomMessageHandler;

namespace SiteWeb.Controllers
{
    public class WeiXin001Controller : BaseController
    {
        public static readonly string Token = "123456"; //WebConfigurationManager.AppSettings["WeixinToken"];//与微信公众账号后台的Token设置保持一致，区分大小写。
        public static readonly string EncodingAESKey = "SIR6rnJjsSl17CwqJMLDKaqJtiXYWoacZNKCLp1lRyy"; //WebConfigurationManager.AppSettings["WeixinEncodingAESKey"];//与微信公众账号后台的EncodingAESKey设置保持一致，区分大小写。
        public static readonly string AppId = "wx965f031c1746f165";//WebConfigurationManager.AppSettings["WeixinAppId"];//与微信公众账号后台的AppId设置保持一致，区分大小写。

        readonly Func<string> _getRandomFileName = () => DateTime.Now.ToString("yyyyMMdd-HHmmss") + Guid.NewGuid().ToString("n").Substring(0, 6);

        public WeiXin001Controller()
        {
        ...
        public ActionResult TestB()
        {
            ...
            //if (userInfo != null)
            //{
            //    string nickname = userInfo.nickname;   //用户昵称  
            //    int sex = userInfo.sex;    //值为1时是男性，值为2时是女性，值为0时是未知  
            //    string province = userInfo.province;    //用户个人资料填写的省份  
            //                                            //更多......  
            //}
        ...
        {
            // OAuthUserInfo userInfo = OAuthApi.GetAuthorizeUrl(access_token, openId);
