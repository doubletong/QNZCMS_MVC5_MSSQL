...
namespace TZGCMS.Model.Admin.InputModel.Videos
{
    public class VideoCategoryIM
    {
        ...
        [Remote("IsSeoNameUnique", "VideoCategory", AdditionalFields = "Id", ErrorMessageResourceType = typeof(Validations), ErrorMessageResourceName = "IsExist")]
